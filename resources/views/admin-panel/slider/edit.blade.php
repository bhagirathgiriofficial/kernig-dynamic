...
@section('page-title', 'Update Slider | Admin Panel')
@push('styles')
...
<div class="page">
    ...
    <div class="page-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">{{trans('language.update_slider_image')}}</li>
        </ol>
    </div>
    <!-- / Page breadcrumbs -->
    <!-- Page -->
                        ...
                        <div class="col-lg-12">
                            <div class="">
                                ...
                                <div class="example-wrap">
                                    ...
                                    <div class="example">
                                        {!! Form::open(['class' => 'add-slider-form', 'method' => 'post', 'url' => route('adminPanel.slider.update', ['id' => ev($slider->slider_id)]), 'files' => true ]) !!}
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="row">
                                                            <div class="col-md-6 form-group required">
                                                                ...
                                                                {!! Form::text('slider_title', old('slider_title', ($slider->slider_title ?? '')), ['class' => 'form-control', 'id' => 'slider_title','minLength'=> 10, 'maxLength' => 30, 'autocomplete' => 'off', 'placeholder' =>__('language.slider_title'), 'data-url' => route('adminPanel.slider.checkSliderTitle', ['id' => ev($slider->slider_id)])]) !!}
                                                            </div>
                                                            <div class="col-md-6 form-group required">
                                                                <label class="form-control-label" for="slider_link">@lang('language.slider_link')</label>
                                                                {!! Form::url('slider_link', old('slider_link', ($slider->slider_link)), ['class' => 'form-control', 'id' => 'slider_link', 'autocomplete' => 'off', 'maxLength' => 3000, 'placeholder' =>__('language.slider_link'), 'data-bv-uri-message' => "The website address is not valid" ]) !!}
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group required">
                                                            ...
                                                            <textarea name="slider_description" class="form-control" rows="3" maxlength="100">{{$slider->slider_description}}</textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group not-required">
                                                            ...
                                                            <input type="file" name="slider_image" id="input-file-disable-remove" class="dropify" data-show-remove="flase" data-default-file="{{$image_url}}"/>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 mt-20">
                                                <div class="form-group mb-0">
                                                    <button type="submit" class="btn btn-primary btn-submit" data-toggle="tooltip" data-placement="top" data-trigger="hover" data-original-title="{{ __('language.update_slider_image') }}">
                                                        <i class="fa fa-save"></i> &nbsp; {{ __('language.update_slider_image') }}
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
