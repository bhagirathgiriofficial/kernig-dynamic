    ...
    <table style="width: 100%; background-color: #f2f2f2;">
                  ...
                  <table class="textTop ">
                    ...
                    <tr>
                      <td class="responsiveTable" style="padding: 10px 0px; color: #888888; font-size: 16px; font-weight: 500; letter-spacing: 1px;">
                        Here's a summary of your purchase. When we ship an item, we will send an update with tracking details.
                      </td>
                    </tr>
                    @endif
                  </table>
      ...
      <table style="width: 100%;  padding: 0% 5%;">
        ...
        <table style="width: 100%; padding: 0px 5%">
            <tr>
                <td class="order_details" style="text-align: left; font-size: 18px; color: #1c1c1c; letter-spacing: 1px; padding-bottom: 20px;"> Order Details
                </td>
            </tr>
        </table>
