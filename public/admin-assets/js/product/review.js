        ...
        getReview: function () {
            ...
            data_table = table = $dataTable.DataTable({
                ...
                ajax: {
                    ...
                    data: function (d) {
                        d.Review_name = $("input[name=Review_name]").val();
                    }
                },
                columnDefs: [
                    {
                ...
                { data: "user_details", name: "user_details", searchable:false },
                { data: "product_basic_details", name: "product_basic_details"},
                { data: "review_title", name: "title", orderable:false},
                { data: "review_message", name: "message", orderable:false},
                { data: "review_date", name: "date"},
        ...
        changeStatus: function () {
            ...
            $data_table_container.on("click", ".change-status", function () {
                ...
                $.each(rows_selected, function (index, rowId) {
                    ids.push(rowId.product_review_id);
                });
