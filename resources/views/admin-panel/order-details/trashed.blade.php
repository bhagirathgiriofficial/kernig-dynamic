...
@section('page-title', 'Trashed Order Details | Admin Panel')
...
<div class="page"> 
 ...
 <div class="page-header">
    <div class="row">
        <div class="col-md-6">
            <h1 class="page-title">Trashed Order Details Management</h1>
            <ol class="breadcrumb">
                <li class="breadcrumb-item">Dashboard</li>
                <li class="breadcrumb-item"><a href="{{ route('adminPanel.orderDetails.index',['type' => 'all-orders' ] )}}">Order Details</a></li>
                <li class="breadcrumb-item active">Trashed Order Details</li>
            </ol>
        </div>
    </div>
</div>
                ...
                <div class="col-lg-12">
                    <div class="">
                        ...
                        <div class="example-wrap ">
                            <div style="float: left;"><h4 class="example-title mb-1">Trashed Order Details</h4>
                            <p class="">Below are the list of Trashed Order Details.</p>
                            </div>
                            <div class="example">
                                <div class="data-table-container">
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-hover table-striped dataTable w-full" data-url="{{ route('adminPanel.orderDetails.getTashedOrderDetails') }}" data-undo-delete-url="{{ route('adminPanel.orderDetails.undoDelete') }}" data-destroy-url="{{ route('adminPanel.orderDetails.destroy') }}">
...
<script src="{{ asset('admin-assets/js/orderDetails/trashed.js') }}"></script>
@endpush
