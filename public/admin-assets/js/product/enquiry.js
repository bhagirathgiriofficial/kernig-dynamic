        ...
        getEnquiry: function () {
            ...
            data_table = table = $dataTable.DataTable({
                ...
                ajax: {
                    ...
                    data: function (d) {
                        d.enquiry_name = $("input[name=enquiry_name]").val();
                    }
                },
                columnDefs: [
                    {
                ...
                { data: "enquiry_comment", name: "comment",  searchable:false },
            ...
            $dataTable
                ...
                .on("click", 'input[type="checkbox"]', function (e) {
                    ...
                    Enquiry.updateDataTableSelectAllCtrl(table);
        ...
        changeStatus: function () {
            ...
            $data_table_container.on("click", ".change-status", function () {
                ...
                $.each(rows_selected, function (index, rowId) {
                    ids.push(rowId.product_enquiry_id);
                });
