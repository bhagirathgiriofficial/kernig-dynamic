...
@section('page-title', 'Saree Measurement | Admin Panel')
@push('styles')
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Saree Measurement</li>
                </ol>
            </div>
            <div class="col-md-6">
                <a href="{{ route('adminPanel.sareeMeasurement.create') }}">
                                    ...
                                    <div class="example">
                                        <div class="data-table-container">
                                            <div class="table-responsive">
                                                <table class="table table-bordered table-hover table-striped dataTable w-full" data-url="{{ route('adminPanel.sareeMeasurement.getMeasurmenet') }}" data-change-status-url="{{ route('adminPanel.sareeMeasurement.changeStatus') }}" data-destroy-url="{{ route('adminPanel.sareeMeasurement.destroy') }}">
...
<script src="{{ asset('admin-assets/js/sareeMeasurement/view.js') }}"></script>
@endpush
