...
@section('page-title', 'Faq | Admin Panel')
@push('styles')
...
<div class="page">
    ...
    <div class="page-header">
        <div class="row">
            ...
            <div class="col-md-6">
                <a href="{{ route('adminPanel.faq.create') }}">
                    <button type="button" class="btn btn-floating btn-primary float-right btn-sm mt-1" data-toggle="tooltip" data-placement="left" data-trigger="hover" data-original-title="Add Faq">
                                        ...
                                        <div class="row clearfix">
                                           <div class="col-lg-6 col-md-12 pd-0">
                                                <div class="form-group">
                                                    {!! Form::text('faq_question', '', ['class' => 'form-control', 'id' => 'faq_question', 'autocomplete' => 'off', 'placeholder' =>__('language.faq_question'), ]) !!}
                                                </div>
                                            </div>
                                           <div class="col-lg-6 col-md-12">
                                                <div class="row">
                                                   <div class="col-lg-6 col-md-12">
                                                        <div class="form-group">
                                                            <button type="submit" class="btn btn-primary" name="Search" data-toggle="tooltip" data-placement="bottom" data-trigger="hover" data-original-title="{{ __('language.fliter_faq') }}">
                                                                <i class="fa fa-search"></i> &nbsp; {{ __('language.fliter_faq') }}
                                                            </button>
                                                        </div>
                                                    </div>
                                                   <div class="col-lg-6 col-md-12">
                                    ...
                                    <div class="example">
                                        <div class="data-table-container">
                                            <div class="table-responsive">
                                                <table class="table table-bordered table-hover table-striped dataTable w-full" data-url="{{ route('adminPanel.faq.getFaqs') }}" data-change-status-url="{{ route('adminPanel.faq.changeStatus') }}" data-destroy-url="{{ route('adminPanel.faq.destroy') }}">
...
<script src="{{ asset('admin-assets/js/faq/view.js') }}"></script>
@endpush
