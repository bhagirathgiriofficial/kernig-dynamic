...
@section('page-title', 'Update Saree Measurement | Admin Panel')
@push('styles')
...
<div class="page">
    ...
    <div class="page-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">{{trans('language.update_saree_measurement')}}</li>
        </ol>
    </div>
    <!-- / Page breadcrumbs -->
    <!-- Page -->
                        ...
                        <div class="col-lg-12">
                            <div class="">
                                ...
                                <div class="example-wrap">
                                    ...
                                    <div class="example">
                                        {!! Form::open(['class' => 'add-saree-measurement-form', 'method' => 'post', 'url' => route('adminPanel.sareeMeasurement.update',['id' => ev($sareeMeasurement->saree_measurement_id)]), 'files' => true ]) !!}
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="row">
                                                    <div class="col-md-4 form-group required">
                                                        <label class="form-control-label" for="measurement_title">@lang('language.measurement_title')</label>
                                                        {!! Form::text('measurement_title', old('measurement_title', ($sareeMeasurement->saree_measurement_title)), ['class' => 'form-control', 'id' => 'measurement_title', 'autocomplete' => 'off', 'maxLength' => '100', 'placeholder' =>__('language.measurement_title'), 'data-url' => route('adminPanel.sareeMeasurement.checkMeasurementTitle',['id' => ev($sareeMeasurement->saree_measurement_id)])]) !!}
                                                    </div>
                                                    <div class="col-md-4 form-group required">
                                                        <label class="form-control-label" for="measurement_price">@lang('language.measurement_price')</label>
                                                        {!! Form::number('measurement_price', old('measurement_price', ($sareeMeasurement->saree_measurement_price)), ['class' => 'form-control', 'id' => 'measurement_price', 'min' => 0,'max' => 99999,  'step' => 'any', 'autocomplete' => 'off', 'placeholder' =>__('language.measurement_price'), ]) !!}
                                                    </div>
                                                    <div class="col-md-4 form-group">
                                                        ...
                                                        <select name="custom" id="custom" class="form-control">
                                                            <option value=""> No Custom Measurement </option>
                                                            @foreach($custom as $value)
                                                            <option value="{{$value['measurement_id']}}" {{$value->measurement_id==$sareeMeasurement->saree_custom_id ? "selected" : ""}}> {{$value['measurement_title']}} </option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 mt-20">
                                                <div class="form-group mb-0">
                                                    <button type="submit" class="btn btn-primary btn-submit" data-toggle="tooltip" data-placement="top" data-trigger="hover" data-original-title="{{ __('language.update_saree_measurement') }}">
                                                        <i class="fa fa-save"></i> &nbsp; {{ __('language.update_saree_measurement') }}
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
