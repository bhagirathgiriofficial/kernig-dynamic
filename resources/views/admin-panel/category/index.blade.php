...
@section('page-title', 'Category | Admin Panel')
@push('styles')
...
<div class="page">
    ...
    <div class="page-header">
        <div class="row">
            ...
            <div class="col-md-6">
                <a href="{{ route('adminPanel.category.create') }}">
                    <button type="button" class="btn btn-floating btn-primary float-right btn-sm mt-1" data-toggle="tooltip" data-placement="left" data-trigger="hover" data-original-title="Add Category"><i class="icon wb-plus" aria-hidden="true"></i></button>
                </a>
               <!--  <span class="float-right" style="margin: 5px;"></span>
                <a href="{{route('adminPanel.category.viewTrash')}}">
                    <button type="button" class="btn btn-floating btn-primary float-right btn-sm mt-1" data-toggle="tooltip" data-placement="bottom" data-trigger="hover" data-original-title="View Trash"><i class="icon fa fa-trash" aria-hidden="true"></i></button>
                </a> -->
            </div>
        </div>
    </div>
                                    ...
                                    <div class="example">
                                        <div class="data-table-container">
                                            <div class="table-responsive">
                                                ...
                                                <table class="table table-bordered table-hover table-striped dataTable w-full" data-url="{{ route('adminPanel.category.getCategories') }}" data-change-status-url="{{ route('adminPanel.category.changeStatus') }}" data-destroy-url="{{ route('adminPanel.category.moveToTrash') }}" data-change-order="">
