var Product = (function () {
    ...
    return {
            ...
            data_table = table = $dataTable.DataTable({
                initComplete: function () {
                    ...
                    $(
                        ...
                        // '<button type"button" title="Change Stock Status" class="btn btn-icon btn-default btn-outline fa fa-shopping-bag change-stock-status" disabled></button>' +
                ...
                ajax: {
                    ...
                    data: function (d) {
                        ...
                        d.category_id = $(".category-picker").val();
                    }
                },
                columnDefs: [
                    {
                ...
                columns: [
                    ...
                    { data: "product_id", name: "id"},
                    { data: "product_name", name: "product_name" },
                    { data: "product_code", name: "product_code", orderable:false},
                    { data: "product_price", name: "product_price"},
                    { data: "category", name: "category"  , orderable:false},
                    { data: "type", name: "type"  , orderable:false},
                    { data: "product_order", name: "product_order"  , orderable:false},
            ...
            $dataTable
                ...
                .on("click", 'input[type="checkbox"]', function (e) {
                    ...
                    if (
                        ...
                        $(".change-stock-status").prop("disabled", false);
                    } else {
                        $(".change-status").prop("disabled", true);
                        $(".dt-delete").prop("disabled", true);
                        $(".change-stock-status").prop("disabled", true);
                    }
                    ...
                    Product.updateDataTableSelectAllCtrl(table);
        ...
        //     // Handle form submission event
        //     $data_table_container.on("click", ".change-stock-status", function () {
        //         // Iterate over all selected checkboxes
        //         var ids = [];
        //         $.each(rows_selected, function (index, rowId) {
        //             ids.push(rowId.product_id);
        ...
        //         $.ajax({
        //             type: "POST",
        //             url: $dataTable.data("change-stock-status-url"),
        //             data: { ids: ids },
        //             beforeSend: function () {
        //                 $(".change-stock-status").prop("disabled", true);
        //             },
        ...
        destroyRecord: function () {
            ...
            $data_table_container.on("click", ".dt-delete", function () {
                ...
                // console.log($data_table_container);
                // alert('dsf');
...
function changeType(elem) {
    var id  = $(elem).data("id");
    var val = $(elem).val();
    var goToUrl = $(".dataTable").data("change-type-url");
    $.ajax({
        type : "POST",
        url: goToUrl,
        data : {
