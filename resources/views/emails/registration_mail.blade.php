                  ...
                  <table class="textTop">
                    ...
                    <tr>
                      <td class="responsiveTabletrtd" style="padding: 0px 0px; color: #2e2e2d; font-size: 16px; font-weight: 600;">
                        ...
                        Thank You very much for registration with {{$accountSettingData->site_name}}.
                      </td>
                    </tr>
                    @if($user_type != 1)
                    <tr>
                      <td class="responsiveTable" style="padding: 10px 0px; color: #888888; font-size: 16px; font-weight: 500; letter-spacing: 1px;">
                        You are just one step away from completing your account details. Kindly verify your email by clicking on the below link- <a href="{{ url('email-verification') }}/{{$user_id}}">Click Here</a>
                      </td>
                    </tr>
                    @endif
                  </table>
