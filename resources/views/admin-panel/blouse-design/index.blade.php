...
@section('page-title', 'Blouse Design | Admin Panel')
@push('styles')
...
<div class="page">
    ...
    <div class="page-header">
        <div class="row">
            <div class="col-md-6">
                <h1 class="page-title">Blouse Design</h1>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('adminPanel.dashboard') }}">Dashboard</a></li>
                    <li class="breadcrumb-item active">Blouse Design</li>
                </ol>
            </div>
            <div class="col-md-6">
                <a href="{{ route('adminPanel.blouse.create') }}">
                    <button type="button" class="btn btn-floating btn-primary float-right btn-sm mt-1" data-toggle="tooltip" data-placement="left" data-trigger="hover" data-original-title="Add Blouse Design">
                                        ...
                                        <div class="row clearfix">
                                            <div class="col-lg-6 col-md-12 pd-0">
                                                <div class="form-group">
                                                    {!! Form::text('blouse_title', '', ['class' => 'form-control', 'id' => 'blouse_title', 'autocomplete' => 'off', 'placeholder' =>__('language.blouse_title'), ]) !!}
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-12">
                                                <div class="row">
                                                    <div class="col-lg-6 col-md-12">
                                                        <div class="form-group">
                                                            <button type="submit" class="btn btn-primary" name="Search" data-toggle="tooltip" data-placement="bottom" data-trigger="hover" data-original-title="Filter Design">
                                                                <i class="fa fa-search"></i> &nbsp; {{ __('language.filter_desgin') }}
                                                            </button>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6 col-md-12">
                                    ...
                                    <div class="example">
                                        <div class="data-table-container">
                                            <div class="table-responsive">
                                                {!!Form::open(['id' => 'change-order-form', 'url' => route('adminPanel.blouse.changeOrder') ])!!}
                                                <table class="table table-bordered table-hover table-striped dataTable w-full" data-url="{{ route('adminPanel.blouse.getDesigns') }}" data-change-status-url="{{ route('adminPanel.blouse.changeStatus') }}" data-destroy-url="{{ route('adminPanel.blouse.destroy') }}">
...
<script src="{{ asset('admin-assets/js/blouse/view.js') }}"></script>
@endpush
