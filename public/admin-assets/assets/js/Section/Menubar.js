    ...
    var Menubar = (function (_Component) {
        ...
        function Menubar() {
            ...
            var _this = babelHelpers.possibleConstructorReturn(
                ...
                (_ref =
                    Menubar.__proto__ ||
                    Object.getPrototypeOf(Menubar)).call.apply(
                    _ref,
                    [this].concat(args)
                )
            );
                            ...
                            navbars: [
                                {
                                    position: "bottom",
                                    content: [
                                        '<div class="site-menubar-footer">\n              <a href="javascript: void(0);" class="fold-show" data-placement="top" data-toggle="tooltip" data-original-title="Settings">\n                <span class="icon wb-settings" aria-hidden="true"></span>\n              </a>\n              <a href="javascript: void(0);" data-placement="top" data-toggle="tooltip" data-original-title="Lock">\n                <span class="icon wb-eye-close" aria-hidden="true"></span>\n              </a>\n              <a href="/admin-panel/logout" data-placement="top" data-toggle="tooltip" data-original-title="Logout">\n                <span class="icon wb-power" aria-hidden="true"></span>\n              </a>\n            </div>',
                                    ],
                                },
                            ],
                        });
            ...
            },
            {
                ...
                value: function open() {
                    this.animate(
                        function () {
                            $BODY.addClass(
                                "site-menubar-open site-menubar-unfold"
                            );
            ...
            },
            {
                ...
                value: function hide() {
                    this.animate(
                        function () {
                            $BODY.addClass(
                                "site-menubar-hide site-menubar-unfold"
                            );
                        },
                        function () {
                            this.scrollable.enable();
