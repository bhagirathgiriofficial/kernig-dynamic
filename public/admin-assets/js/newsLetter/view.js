         ...
         getNewsLetter: function () {
            ...
            data_table = table = $dataTable.DataTable({
                ...
                buttons: [
                    ...
                    ajax: {
                        ...
                        data: function (d) {
                            d.NewsLetter_name = $("input[name=NewsLetter_name]").val();
                        }
                    },
                    columnDefs: [
                    {
                ...
                { data: "news_letter_email", name: "news_letter_email" },
            ...
            .on("click", 'input[type="checkbox"]', function (e) {
                ...
                if (this.checked) {
                    ...
                    NewsLetter.updateDataTableSelectAllCtrl(table);
