var Measuremenet = (function () {
    ...
    return {
         ...
         */
         init: function () {
            Measuremenet.getMeasuremenet();
            Measuremenet.changeStatus();
            Measuremenet.destroyRecord();
        ...
        /**
         * Get Measuremenet list.
         */
         getMeasuremenet: function () {
            ...
            data_table = table = $dataTable.DataTable({
                initComplete: function () {
                    ...
                    // $(".buttons-csv").html(
                    //     '<i title="Download CSV" class="fa fa-file-text" />'
                    //     );
                    // $(".buttons-pdf").html(
                    //     '<i title="Download PDF" class="fa fa-file"/>'
                    //     );
                ...
                //     }
                    ...
                    ajax: {
                        ...
                        data: function (d) {
                            d.Measuremenet_name = $("input[name=Measuremenet_name]").val();
                        }
                    },
                    columnDefs: [
                    {
                ...
                { data: "saree_measurement_id", name: "saree_measurement_id" },
                { data: "saree_measurement_title", name: "saree_measurement_title" },
                { data: "saree_measurement_price", name: "saree_measurement_price" },
                { data: "saree_custom_id", name: "saree_custom_id" },
            ...
            .on("click", 'input[type="checkbox"]', function (e) {
                ...
                if (this.checked) {
                    ...
                    Measuremenet.updateDataTableSelectAllCtrl(table);
         ...
         changeStatus: function () {
            ...
            $data_table_container.on("click", ".change-status", function () {
                ...
                $.each(rows_selected, function (index, rowId) {
                    ids.push(rowId.salwar_measurement_id);
                });
                $.ajax({
                    type: "POST",
