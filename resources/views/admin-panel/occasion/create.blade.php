...
@section('page-title', 'Add Occasion | Admin Panel')
@push('styles')
                        ...
                        <div class="col-lg-12">
                            <div class="">
                                ...
                                <div class="example-wrap">
                                    ...
                                    <div class="example">
                                        {!! Form::open(['class' => 'add-occasion-form', 'method' => 'post', 'url' => route('adminPanel.occasion.store'), 'files' => true ]) !!}
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group required">
                                                            ...
                                                            {!! Form::text('occasion_name', '', ['class' => 'form-control', 'id' => 'occasion_name', 'autocomplete' => 'off', 'placeholder' =>__('language.occasion_name'),'maxLength' => 100, 'data-url' => route('adminPanel.occasion.checkOccasionTitle')]) !!}
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 mt-20">
                                                <div class="form-group mb-0">
                                                    <button type="submit" class="btn btn-primary btn-submit" data-toggle="tooltip" data-placement="top" data-trigger="hover" data-original-title="{{ __('language.create_occasion') }}">
                                                        <i class="fa fa-save"></i> &nbsp; {{ __('language.create_occasion') }}
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
