var Gallary = (function () {
    ...
    return {
         ...
         */
         init: function () {
            Gallary.getGallary();
            Gallary.changeStatus(); 
            Gallary.destroyRecord();
         ...
         getGallary: function () {
            ...
            data_table = table = $dataTable.DataTable({
                ...
                ajax: {
                    ...
                    data: function (d) {
                        d.image_title = $("input[name=image_title]").val();
                    }
                },
                columnDefs: [
                {
                ...
                { data: "gallary_image", name: "gallary_image"},
                { data: "gallary_order", name: "gallary_order"},
            ...
            .on("click", 'input[type="checkbox"]', function (e) {
                ...
                if (this.checked) {
                    ...
                    Gallary.updateDataTableSelectAllCtrl(table);
