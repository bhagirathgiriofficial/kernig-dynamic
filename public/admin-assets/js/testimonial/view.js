    ...
    return {
            ...
            data_table = table = $dataTable.DataTable({
                initComplete: function () {
                    ...
                    $(
                        ...
                        '<button type="button" title="Update Order" class="btn btn-icon btn-default btn-outline change-order"><i class="icon fa fa-sort" aria-hidden="true"></i></button>' +
                ...
                //     }
                    ...
                    ajax: {
                        ...
                        data: function (d) {
                            d.testimonial_name = $("input[name=testimonial_name]").val();
                        }
                    },
                    columnDefs: [
                    {
                ...
                { data: "testimonial_name", name: "testimonial_name" },
                { data: "testimonial_message", name: "testimonial_message" },
                { data: "testimonial_place", name: "testimonial_place" },
                { data: "testimonial_order", name: "testimonial_order" },
                { data:'testimonial_homepage' , name: 'testimonial_homepage',orderable:false},
                { data: "testimonial_image", name: "testimonial_image", orderable: false },
        ...
        */
        changeOrder: function(){
            ...
            var $dataTable = $(".dataTable");
            // Handle form submission event
            $data_table_container.on("click", ".change-order", function(){
               $("#change-order-form").submit(); 
            })
        }
    };
})();
