var Shipping = (function () {
    ...
    return {
         ...
         */
        init: function () {
            Shipping.getShippingCountries();
            Shipping.changeStatus();
            Shipping.destroyRecord();
        ...
        getShippingCountries: function () {
            ...
            data_table = table = $dataTable.DataTable({
                ...
                ajax: {
                    ...
                    data: function (d) {
                        d.country_name = $("input[name=country_name]").val();
                    }
                },
                columnDefs: [
                    {
            ...
            $dataTable
                ...
                .on("click", 'input[type="checkbox"]', function (e) {
                    ...
                    Shipping.updateDataTableSelectAllCtrl(table);
