<nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega" role="navigation">
    <div class="navbar-header">
        ...
        <div class="navbar-brand navbar-brand-center site-gridmenu-toggle p-5">
            <span class="navbar-brand-text hidden-xs-down" style="font-weight: normal;">
                <img src="{{asset('admin-assets\images\logo.png')}}" class="img-responsive" width="210px;" height="50px">
            </span>
        </div>
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link navbar-avatar" data-toggle="dropdown" href="#" aria-expanded="false" data-animation="scale-up" role="button">
                        <span class="avatar avatar-online">
                            {!! show_user_image(auth()->user()->profile_image, auth()->user()->name) !!}
                            <i></i>
                        </span>
                    </a>
                    <div class="dropdown-menu mr-2" role="menu">
                        <a class="dropdown-item" href="{{ route('adminPanel.profile') }}" role="menuitem"><i class="icon wb-user" aria-hidden="true"></i> Profile</a>
                        <div class="dropdown-divider" role="presentation"></div>
                        <a class="dropdown-item" href="{{ route('adminPanel.logout') }}" role="menuitem"><i class="icon wb-power" aria-hidden="true"></i> Logout</a>
                    </div>
                </li>
                {{-- <li class="nav-item dropdown">
