         ...
         getOccasion: function () {
            ...
            data_table = table = $dataTable.DataTable({
                initComplete: function () {
                    ...
                    $(
                        ...
                        '<div class="btn-group" role="group"> ' +
                          '<button type="button" title="Update Order" class="btn btn-icon btn-default btn-outline change-order"><i class="icon fa fa-exchange" aria-hidden="true"></i></button>' +
                ...
                buttons: [
                    ...
                    ajax: {
                        ...
                        data: function (d) {
                            d.occasion_name = $("input[name=occasion_name]").val();
                        }
                    },
                    columnDefs: [
                    {
                ...
                { data: "occasion_name", name: "occasion_name" },
                { data: "occasion_id", name: "occasion_id" },
                { data: "occasion_order", name: "occasion_order" },
            ...
            .on("click", 'input[type="checkbox"]', function (e) {
                ...
                if (this.checked) {
                    ...
                    Occasion.updateDataTableSelectAllCtrl(table);
