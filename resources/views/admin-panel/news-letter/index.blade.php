...
@section('page-title', 'News Letter | Admin Panel')
...
<div class="page">
   ...
   <div class="page-header">
        <div class="row">
            <div class="col-md-6">
                <h1 class="page-title">News Letter Management</h1>
                <ol class="breadcrumb">
                            ...
                            <div class="col-lg-12">
                                <div class="">
                                    ...
                                    <div class="example-wrap ">
                                        <h4 class="example-title mb-1">News Letter</h4>
                                        <p class="">Below are the list of News Letters.</p>
                                        <div class="example">
                                            <div class="data-table-container">
                                                <div class="table-responsive">
                                                    <table class="table table-bordered table-hover table-striped dataTable w-full" data-url="{{ route('adminPanel.newsLetter.getNewsLetters') }}" data-change-status-url="{{ route('adminPanel.newsLetter.changeStatus') }}" data-destroy-url="{{ route('adminPanel.newsLetter.destroy') }}">
...
<script src="{{ asset('admin-assets/js/newsLetter/view.js') }}"></script>
@endpush
