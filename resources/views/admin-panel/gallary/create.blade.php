...
@section('page-title', 'Add Gallery | Admin Panel')
@push('styles')
...
<div class="page">
    ...
    <div class="page-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">{{trans('language.create_gallary')}}</li>
        </ol>
    </div>
    <!-- / Page breadcrumbs -->
    <!-- Page -->
                        ...
                        <div class="col-lg-12">
                            <div class="">
                                ...
                                <div class="example-wrap">
                                    ...
                                    <div class="example">
                                        {!! Form::open(['class' => 'add-gallary-form', 'method' => 'post', 'url' => route('adminPanel.gallary.store'), 'files' => true ]) !!}
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="row">
                                                            <div class="col-md-12 form-group required">
                                                                ...
                                                                {!! Form::text('image_title', '', ['class' => 'form-control', 'id' => 'image_title', 'autocomplete' => 'off', 'placeholder' =>__('language.image_title'), 'data-url' => route('adminPanel.gallary.checkGallaryTitle')]) !!}
                                                            </div>
                                                           <!--  <div class="col-md-12">
                                                                <div class="form-group">
                                                                    <label class="form-control-label" for="image_description">@lang('language.image_description')
                                                                    </label>
                                                                    <div id="total-char">Upto 3000 characters only</div>
                                                                    {!! Form::textarea('image_description', '', ['class' => 'editor-textarea', 'id' => 'image_description', 'autocomplete' => 'off']) !!}
                                                                </div>
                                                            </div> -->
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group required">
                                                            ...
                                                            <input type="file" name="gallary_image" id="input-file-disable-remove" class="dropify" data-show-remove="true" data-default-file="" required=""/>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 mt-20">
                                                <div class="form-group mb-0">
                                                    <button type="submit" class="btn btn-primary btn-submit" data-toggle="tooltip" data-placement="top" data-trigger="hover" data-original-title="{{ __('language.create_gallary') }}">
                                                        <i class="fa fa-save"></i> &nbsp; {{ __('language.create_gallary') }}
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
