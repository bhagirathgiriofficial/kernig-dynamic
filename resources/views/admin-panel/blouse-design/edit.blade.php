...
@section('page-title', 'Update Blouse Design | Admin Panel')
@push('styles')
...
<div class="page">
    ...
    <div class="page-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('adminPanel.blouse.index') }}">Blouse</a></li>
            <li class="breadcrumb-item active">{{trans('language.update_blouse')}}</li>
        </ol>
    </div>
    <!-- / Page breadcrumbs -->
    <!-- Page -->
                        ...
                        <div class="col-lg-12">
                            <div class="">
                                ...
                                <div class="example-wrap">
                                    ...
                                    <div class="example">
                                        {!! Form::open(['class' => 'add-blouse-design-form', 'method' => 'post', 'url' => route('adminPanel.blouse.update', ['id' => ev($design->blouse_design_id)]), 'files' => true ]) !!}
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="row">
                                                            <div class="col-md-6 form-group required">
                                                                ...
                                                                {!! Form::text('blouse_title', old('blouse_title', ($design->blouse_design_name ?? '')), ['class' => 'form-control', 'id' => 'blouse_title', 'autocomplete' => 'off','maxLength' => 100, 'placeholder' =>__('language.blouse_title'), required =>"required", 'data-url' => route('adminPanel.blouse.checkBlouseTitle', ['id' => ev($design->blouse_design_id)])])!!}
                                                            </div>
                                                           <!--  <div class="col-md-12 form-group">
                                                                <label class="form-control-label" for="blouse_order">@lang('language.blouse_order')</label>
                                                                {!! Form::number('blouse_order', old('blouse_order', ($design->blouse_design_order ?? '')), ['class' => 'form-control', 'id' => 'blouse_order', 'autocomplete' => 'off', 'placeholder' =>__('language.blouse_order'), 'min' => 0 ]) !!}
                                                            </div> -->
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group not-required">
                                                            ...
                                                            <input type="file" name="blouse_design_image" id="input-file-disable-remove" class="dropify" data-show-remove="false" data-default-file="{{$image_url}}"/>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 mt-20">
                                                <div class="form-group mb-0">
                                                    <button type="submit" class="btn btn-primary btn-submit" data-toggle="tooltip" data-placement="top" data-trigger="hover" data-original-title="{{ __('language.update_blouse') }}">
                                                        <i class="fa fa-save"></i> &nbsp; {{ __('language.update_blouse') }}
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
