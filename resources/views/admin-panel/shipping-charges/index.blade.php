...
@section('page-title', 'Shipping Charges | Admin Panel')
@push('styles')
...
<div class="page">
    ...
    <div class="page-header">
        <div class="row">
            ...
            <div class="col-md-6">
                <a href="{{ route('adminPanel.shippingCharges.create') }}">
                    <button type="button" class="btn btn-floating btn-primary float-right btn-sm mt-1" data-toggle="tooltip" data-placement="left" data-trigger="hover" data-original-title="Add Shipping Charges">
                                        ...
                                        <div class="row clearfix">
                                            <div class="col-lg-6 col-md-12 pd-0">
                                                <div class="form-group">
                                                    {!! Form::text('country_name', '', ['class' => 'form-control', 'id' => 'country_name', 'autocomplete' => 'off', 'placeholder' =>__('language.country_name'), ]) !!}
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-12">
                                                <div class="row">
                                                    <div class="col-lg-6 col-md-12">
                                                        <div class="form-group">
                                                            <button type="submit" class="btn btn-primary" name="Search" data-toggle="tooltip" data-placement="bottom" data-trigger="hover" data-original-title="Filter Country">
                                                                <i class="fa fa-search"></i> &nbsp; {{ __('language.filter_country') }}
                                                            </button>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6 col-md-12">
                                    ...
                                    <div class="example">
                                        <div class="data-table-container">
                                            <div class="table-responsive">
                                                <table class="table table-bordered table-hover table-striped dataTable w-full" data-url="{{ route('adminPanel.shippingCharges.getShippingCountries') }}" data-change-status-url="{{ route('adminPanel.shippingCharges.changeStatus') }}" data-destroy-url="{{ route('adminPanel.shippingCharges.destroy') }}">
...
<script src="{{ asset('admin-assets/js/shipping/view.js') }}"></script>
@endpush
