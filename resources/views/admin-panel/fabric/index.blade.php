...
@section('page-title', 'Wood Type | Admin Panel')
@push('styles')
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Wood Type</li>
                </ol>
            </div>
            <div class="col-md-6">
                <a href="{{ route('adminPanel.fabric.create') }}">
                    <button type="button" class="btn btn-floating btn-primary float-right btn-sm mt-1" data-toggle="tooltip" data-placement="left" data-trigger="hover" data-original-title="Add Wood Type">
                                        ...
                                        <div class="row clearfix">
                                           <div class="col-lg-6 col-md-12 pd-0">
                                                <div class="form-group">
                                                    {!! Form::text('fabric_name', '', ['class' => 'form-control', 'id' => 'fabric_name', 'autocomplete' => 'off', 'placeholder' =>__('language.fabric_name'), ]) !!}
                                                </div>
                                            </div>
                                           <div class="col-lg-6 col-md-12">
                                                <div class="row">
                                                   <div class="col-lg-6 col-md-12">
                                                        <div class="form-group">
                                                            <button type="submit" class="btn btn-primary" name="Search" data-toggle="tooltip" data-placement="bottom" data-trigger="hover" data-original-title="{{ __('language.filter_fabric') }}">
                                                                <i class="fa fa-search"></i> &nbsp; {{ __('language.filter_fabric') }}
                                                            </button>
                                                        </div>
                                                    </div>
                                                   <div class="col-lg-6 col-md-12">
                                    ...
                                    <div class="example">
                                        <div class="data-table-container">
                                            <div class="table-responsive">
                                                {!!Form::open(['id' => 'change-order-form', 'url' => route('adminPanel.fabric.changeOrder') ])!!}
                                                <table class="table table-bordered table-hover table-striped dataTable w-full" data-url="{{ route('adminPanel.fabric.getFabrics') }}" data-change-status-url="{{ route('adminPanel.fabric.changeStatus') }}" data-destroy-url="{{ route('adminPanel.fabric.destroy') }}">
...
<script src="{{ asset('admin-assets/js/fabric/view.js') }}"></script>
@endpush
