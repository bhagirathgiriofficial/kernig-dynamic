...
@section('page-title', 'Size | Admin Panel')
@push('styles')
...
<div class="page">
    ...
    <div class="page-header">
        <div class="row">
            ...
            <div class="col-md-6">
                <a href="{{ route('adminPanel.size.create') }}">
                    <button type="button" class="btn btn-floating btn-primary float-right btn-sm mt-1" data-toggle="tooltip" data-placement="left" data-trigger="hover" data-original-title="Add Size">
                                        ...
                                        <div class="row clearfix">
                                            <div class="col-lg-6 col-md-12 pd-0">
                                                <div class="form-group">
                                                    {!! Form::text('Size_name', '', ['class' => 'form-control', 'id' => 'Size_name', 'autocomplete' => 'off', 'placeholder' =>__('language.size'), ]) !!}
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-12">
                                                <div class="row">
                                                   <div class="col-lg-6 col-md-12">
                                                        <div class="form-group">
                                                            <button type="submit" class="btn btn-primary" name="Search" data-toggle="tooltip" data-placement="bottom" data-trigger="hover" data-original-title="{{ __('language.filter_size') }}">
                                                                <i class="fa fa-search"></i> &nbsp; {{ __('language.filter_size') }}
                                                            </button>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6 col-md-12">
                                    ...
                                    <div class="example">
                                        <div class="data-table-container">
                                            <div class="table-responsive">
                                                {!!Form::open(['id' => 'change-order-form', 'url' => route('adminPanel.size.changeOrder') ])!!}
                                                <table class="table table-bordered table-hover table-striped dataTable w-full" data-url="{{ route('adminPanel.size.getSizes') }}" data-change-status-url="{{ route('adminPanel.size.changeStatus') }}" data-destroy-url="{{ route('adminPanel.size.destroy') }}">
...
<script src="{{ asset('admin-assets/js/size/view.js') }}"></script>
@endpush
