         ...
         getBlouse: function () {
            ...
            data_table = table = $dataTable.DataTable({
                ...
                ajax: {
                    ...
                    data: function (d) {
                        d.blouse_title = $("input[name=blouse_title]").val();
                    }
                },
                columnDefs: [
                {
                ...
                columns: [
                    ...
                    { data: "blouse_design_name", name: "blouse_design_name" },
                    { data: "blouse_design_order", name: "blouse_design_order"},
            ...
            .on("click", 'input[type="checkbox"]', function (e) {
                ...
                if (this.checked) {
                    ...
                    Blouse.updateDataTableSelectAllCtrl(table);
         ...
         changeStatus: function () {
            ...
            $data_table_container.on("click", ".change-status", function () {
                ...
                $.each(rows_selected, function (index, rowId) {
                    ids.push(rowId.blouse_design_id);
                });
