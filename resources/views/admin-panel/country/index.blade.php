...
@section('page-title', 'Country | Admin Panel')
@push('styles')
...
<div class="page">
    ...
    <div class="page-header">
        <div class="row">
            ...
            <div class="col-md-6">
                <a href="{{ route('adminPanel.country.create') }}">
                    <button type="button" class="btn btn-floating btn-primary float-right btn-sm mt-1" data-toggle="tooltip" data-placement="left" data-trigger="hover" data-original-title="Add Country">
                                        ...
                                        <div class="row clearfix">
                                            ...
                                            <div class="col-lg-6 col-md-12">
                                                <div class="row">
                                                   <div class="col-lg-6 col-md-12">
                                                        <div class="form-group">
                                                            <button type="submit" class="btn btn-primary" name="Search" data-toggle="tooltip" data-placement="bottom" data-trigger="hover" data-original-title="{{ __('language.filter_country') }}">
                                    ...
                                    <div class="example">
                                        <div class="data-table-container">
                                            <div class="table-responsive">
                                                <table class="table table-bordered table-hover table-striped dataTable w-full" data-url="{{ route('adminPanel.country.getcountries') }}" data-change-status-url="{{ route('adminPanel.country.changeStatus') }}" data-destroy-url="{{ route('adminPanel.country.destroy') }}">
...
<script src="{{ asset('admin-assets/js/country/view.js') }}"></script>
@endpush
