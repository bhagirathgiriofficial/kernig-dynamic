...
@section('page-title', 'Slider Image | Admin Panel')
@push('styles')
...
<div class="page">
    ...
    <div class="page-header">
        <div class="row">
            <div class="col-md-6">
                <h1 class="page-title">Slider Image</h1>
                <ol class="breadcrumb">
            ...
            <div class="col-md-6">
                <a href="{{ route('adminPanel.slider.create') }}">
                    <button type="button" class="btn btn-floating btn-primary float-right btn-sm mt-1" data-toggle="tooltip" data-placement="left" data-trigger="hover" data-original-title="Add Slider Image">
                                        ...
                                        <div class="row clearfix">
                                            <div class="col-lg-6 col-md-12 pd-0">
                                                <div class="form-group">
                                                    {!! Form::text('slider_title', '', ['class' => 'form-control', 'id' => 'slider_title', 'autocomplete' => 'off', 'placeholder' =>__('language.slider_title'), ]) !!}
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-12">
                                                <div class="row">
                                                    <div class="col-lg-6 col-md-12">
                                                        <div class="form-group">
                                                            <button type="submit" class="btn btn-primary" name="Search" data-toggle="tooltip" data-placement="bottom" data-trigger="hover" data-original-title="Filter Slider">
                                                                <i class="fa fa-search"></i> &nbsp; {{ __('language.filter_slider') }}
                                                            </button>
                                                        </div>
                                                    </div>
                                                   <div class="col-lg-6 col-md-12">
                                    ...
                                    <div class="example">
                                        <div class="data-table-container">
                                            <div class="table-responsive">
                                                <table class="table table-bordered table-hover table-striped dataTable w-full" data-url="{{ route('adminPanel.slider.getSliders') }}" data-change-status-url="{{ route('adminPanel.slider.changeStatus') }}" data-destroy-url="{{ route('adminPanel.slider.destroy') }}">
...
<script src="{{ asset('admin-assets/js/slider/view.js') }}"></script>
@endpush
