...
@section('page-title', 'Add Size | Admin Panel')
@push('styles')
                        ...
                        <div class="col-lg-12">
                            <div class="">
                                ...
                                <div class="example-wrap">
                                    ...
                                    <div class="example">
                                        {!! Form::open(['class' => 'add-size-form', 'method' => 'post', 'url' => route('adminPanel.size.store'), 'files' => true ]) !!}
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group required">
                                                            ...
                                                            {!! Form::number('size_name', '', ['class' => 'form-control', 'id' => 'size_name', 'autocomplete' => 'off', 'placeholder' =>__('language.size_name'),'step' => 'any', 'min' => 0 , 'maxLength' => 6, 'data-url' => route('adminPanel.size.checkSizeTitle')]) !!}
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group required">
                                                            <label class="form-control-label" for="size_price">@lang('language.size_price')</label>
                                                            {!! Form::number('size_price', '', ['class' => 'form-control', 'id' => 'size_price', 'autocomplete' => 'off', 'placeholder' =>__('language.size_price'), 'step' => 'any', 'min' => 0 , 'maxLength' => 6 ])!!}
                                                        </div>
                                                    </div>
                                                   <!--  <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label class="form-control-label" for="size_order">@lang('language.size_order')</label>
                                                            {!! Form::number('size_order', '0', ['class' => 'form-control', 'id' => 'size_order', 'autocomplete' => 'off', 'placeholder' =>__('language.size_order'), 'step' => 1, 'min' => 0 ])!!}
                                                        </div>
                                                    </div> -->
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 mt-20">
                                                <div class="form-group mb-0">
                                                    <button type="submit" class="btn btn-primary btn-submit" data-toggle="tooltip" data-placement="top" data-trigger="hover" data-original-title="{{ __('language.create_size') }}">
                                                        <i class="fa fa-save"></i> &nbsp; {{ __('language.create_size') }}
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
