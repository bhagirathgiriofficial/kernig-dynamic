...
@section('page-title', 'Add Country | Admin Panel')
@push('styles')
...
<div class="page">
    ...
    <div class="page-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('adminPanel.country.index') }}">Country</a></li>
                        ...
                        <div class="col-lg-12">
                            <div class="">
                                ...
                                <div class="example-wrap">
                                    ...
                                    <div class="example">
                                        {!! Form::open(['class' => 'add-country-form', 'method' => 'post', 'url' => route('adminPanel.country.store'), 'files' => true ]) !!}
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group required">
                                                            ...
                                                            {!! Form::text('country_name', '', ['class' => 'form-control', 'maxLength' => '75','id' => 'country_name', 'autocomplete' => 'off', 'placeholder' =>__('language.country_name'), 'data-url' => route('adminPanel.country.checkCountryTitle')]) !!}
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 mt-20">
                                                <div class="form-group mb-0">
                                                    <button type="submit" class="btn btn-primary btn-submit" data-toggle="tooltip" data-placement="top" data-trigger="hover" data-original-title="{{ __('language.create_country') }}">
                                                        <i class="fa fa-save"></i> &nbsp; {{ __('language.create_country') }}
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
