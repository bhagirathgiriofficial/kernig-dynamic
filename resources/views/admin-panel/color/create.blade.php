...
@section('page-title', 'Add Color | Admin Panel')
@push('styles')
                        ...
                        <div class="col-lg-12">
                            <div class="">
                                ...
                                <div class="example-wrap">
                                    ...
                                    <div class="example">
                                        {!! Form::open(['class' => 'add-color-form', 'method' => 'post', 'url' => route('adminPanel.color.store'), 'files' => true ]) !!}
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group required">
                                                            ...
                                                            {!! Form::text('color_name', '', ['class' => 'form-control', 'id' => 'color_name', 'autocomplete' => 'off', 'placeholder' =>__('language.color_name'), 'maxLength' => '100', required =>"required", 'data-url' => route('adminPanel.color.checkColorName')]) !!}
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group required">
                                                            ...
                                                            <br />
                                                            <input type="color" class="form-control asColorpicker" data-plugin="asColorPicker" data-mode="simple" name="colorpicker1" id="colorpicker1" required="required" data-url="{{route('adminPanel.color.checkColorName')}}" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-12 mt-20">
                                                        <div class="form-group mb-0">
                                                            <button type="submit" class="btn btn-primary btn-submit" data-toggle="tooltip" data-placement="top" data-trigger="hover" data-original-title="{{ __('language.create_color') }}">
                                                                <i class="fa fa-save"></i> &nbsp; {{ __('language.create_color') }}
                                                            </button>
                                                        </div>
                                                    </div>
                                                </div>
