         ...
         getMeasurement: function () {
            ...
            data_table = table = $dataTable.DataTable({
                ...
                columns: [
                    ...
                    { data: "measurement_title", name: "measurement_title" },
                    { data: "measurement_id", name: "measurement_id" },
                    { data: "measurement_price", name: "measurement_price" },
                    { data: "measurement_chart", name: "measurement_chart" },
            ...
            .on("click", 'input[type="checkbox"]', function (e) {
                ...
                if (this.checked) {
                    ...
                    Measurement.updateDataTableSelectAllCtrl(table);
