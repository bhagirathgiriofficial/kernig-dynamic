...
@section('page-title', 'Testimonial | Admin Panel')
...
<div class="page">
   ...
   <div class="page-header">
        <div class="row">
            ...
            <div class="col-md-6">
                <a href="{{ route('adminPanel.testimonial.create') }}">
                    <button type="button" class="btn btn-floating btn-primary float-right btn-sm mt-1" data-toggle="tooltip" data-placement="left" data-trigger="hover" data-original-title="Add Testimonial"><Id class="icon wb-plus" aria-hidden="true"></i></button>
                </a>
            </div>
        </div>
   </div>
                                    ...
                                    <div class="col-md-12 filter">
                                        ...
                                        <div class="row clearfix">  
                                            <div class="col-lg-6 col-md-12 pd-0">
                                                ...
                                                {!! Form::text('testimonial_name', '', ['class' => 'form-control', 'id' => 'testimonial_name', 'autocomplete' => 'off', 'placeholder' =>__('language.testimonial_name'), ]) !!}
                                                </div>
                                            </div> 
                                            <div class="col-lg-6 col-md-12">
                                                ...
                                                <div class="col-lg-6 col-md-12">
                                                    <div class="form-group">
                                                        <button type="submit" class="btn btn-primary" name="Search" data-toggle="tooltip" data-placement="bottom" data-trigger="hover" data-original-title="{{ __('language.filter_testimonial') }}">
                                                            <i class="fa fa-search"></i> &nbsp; {{ __('language.filter_testimonial') }}
                                                        </button>
                                                    </div>
                                                </div>
                                               <div class="col-lg-6 col-md-12">
                                    ...
                                    <div class="example">
                                        <div class="data-table-container">
                                            <div class="table-responsive">
                                                 {!!Form::open(['id' => 'change-order-form', 'url' => route('adminPanel.testimonial.changeOrder') ])!!}
                                                <table class="table table-bordered table-hover table-striped dataTable w-full" data-url="{{ route('adminPanel.testimonial.getTestimonials') }}" data-change-status-url="{{ route('adminPanel.testimonial.changeStatus') }}" data-destroy-url="{{ route('adminPanel.testimonial.destroy') }}">
...
<script src="{{ asset('admin-assets/js/testimonial/view.js') }}"></script>
@endpush
