...
@section('page-title', 'Occasion | Admin Panel')
@push('styles')
...
<div class="page">
    ...
    <div class="page-header">
        <div class="row">
            ...
            <div class="col-md-6">
                <a href="{{ route('adminPanel.occasion.create') }}">
                    <button type="button" class="btn btn-floating btn-primary float-right btn-sm mt-1" data-toggle="tooltip" data-placement="left" data-trigger="hover" data-original-title="Add Occasion">
                                        ...
                                        <div class="row clearfix">
                                            <div class="col-lg-6 col-md-12 pd-0">
                                                <div class="form-group">
                                                    {!! Form::text('occasion_name', '', ['class' => 'form-control', 'id' => 'occasion_name', 'autocomplete' => 'off', 'placeholder' =>__('language.occasion_name'), ]) !!}
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-12">
                                                <div class="row">
                                                    <div class="col-lg-6 col-md-12">
                                                        <div class="form-group">
                                                            <button type="submit" class="btn btn-primary" name="Search" data-toggle="tooltip" data-placement="bottom" data-trigger="hover" data-original-title="Filter Occasion">
                                                                <i class="fa fa-search"></i> &nbsp; {{ __('language.filter_occasion') }}
                                                            </button>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6 col-md-12">
                                    ...
                                    <div class="example">
                                        <div class="data-table-container">
                                            <div class="table-responsive">
                                                {!!Form::open(['id' => 'change-order-form', 'url' => route('adminPanel.occasion.changeOrder') ])!!}
                                                <table class="table table-bordered table-hover table-striped dataTable w-full" data-url="{{ route('adminPanel.occasion.getOccasions') }}" data-change-status-url="{{ route('adminPanel.occasion.changeStatus') }}" data-destroy-url="{{ route('adminPanel.occasion.destroy') }}">
...
<script src="{{ asset('admin-assets/js/occasion/view.js') }}"></script>
@endpush
