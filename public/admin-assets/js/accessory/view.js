    ...
    return {
         ...
         */
         init: function () {
            ...
            Accessory.changeStatus();
            Accessory.destroyRecord();
         ...
         */
         getAccessories: function () {
            ...
            data_table = table = $dataTable.DataTable({
                initComplete: function () {
                   ...
                   /* $(".buttons-csv").html(
                    ...
                    ajax: {
                        ...
                        data: function (d) {
                            d.accessory_name = $("input[name=accessory_name]").val();
                        }
                    },
                    columnDefs: [
                    {
                ...
                { data: "accessory_name", name: "accessory_name" },
                { data: "accessory_id", name: "accessory_id" },
                { data: "accessory_price", name: "accessory_price"},
            ...
            .on("click", 'input[type="checkbox"]', function (e) {
                ...
                if (this.checked) {
                    ...
                    Accessory.updateDataTableSelectAllCtrl(table);
