...
@section('page-title', 'Gallery | Admin Panel')
@push('styles')
...
<div class="page">
    ...
    <div class="page-header">
        <div class="row">
            ...
            <div class="col-md-6">
                <a href="{{ route('adminPanel.gallary.create') }}">
                    <button type="button" class="btn btn-floating btn-primary float-right btn-sm mt-1" data-toggle="tooltip" data-placement="left" data-trigger="hover" data-original-title="Add Gallery">
                                        ...
                                        <div class="row clearfix">
                                            <div class="col-lg-6 col-md-12 pd-0">
                                                <div class="form-group">
                                                    {!! Form::text('image_title', '', ['class' => 'form-control', 'id' => 'image_title', 'autocomplete' => 'off', 'placeholder' =>__('language.image_title'), ]) !!}
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-12">
                                                <div class="row">
                                                    <div class="col-lg-6 col-md-12">
                                                        <div class="form-group">
                                                            <button type="submit" class="btn btn-primary" name="Search" data-toggle="tooltip" data-placement="bottom" data-trigger="hover" data-original-title="{{ __('language.image_filter') }}">
                                                                <i class="fa fa-search"></i> &nbsp; {{ __('language.image_filter') }}
                                                            </button>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6 col-md-12">
                                    ...
                                    <div class="example">
                                        <div class="data-table-container">
                                            <div class="table-responsive">
                                                 {!!Form::open(['id' => 'change-order-form', 'url' => route('adminPanel.gallary.changeOrder') ])!!}
                                                <table class="table table-bordered table-hover table-striped dataTable w-full" data-url="{{ route('adminPanel.gallary.getGallary') }}" data-change-status-url="{{ route('adminPanel.gallary.changeStatus') }}" data-destroy-url="{{ route('adminPanel.gallary.destroy') }}">
...
<script src="{{ asset('admin-assets/js/gallary/view.js') }}"></script>
@endpush
