                  ...
                  <table class="textTop">
                    ...
                    <tr>
                      <td class="responsiveTable" style="padding: 10px 0px; color: #888888; font-size: 16px; font-weight: 500; letter-spacing: 1px;">
                        You are just one step away from reset your password. Kindly reset by clicking on the below link- <a href="{{ $actionUrl }}">Click Here</a>
                      </td>
                    </tr>
                  </table>
                </td>
      ...
      <table style=" width: 100%; padding: 0px 3%;">
        <tr>
          <td valign="top" width="100%">
            ...
            <a href="{{ url('/') }}" target="_blank" class="web_link" style="font-weight: 600; color: #555555; font-size: 15px;"></a></span></p>
          </td>
        </tr>
      </table>
