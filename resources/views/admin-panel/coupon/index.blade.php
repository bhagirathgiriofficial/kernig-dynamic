...
@section('page-title', 'Coupon | Admin Panel')
@push('styles')
...
<div class="page">
    ...
    <div class="page-header">
        <div class="row">
            ...
            <div class="col-md-6">
                <a href="{{ route('adminPanel.coupon.create') }}">
                    <button type="button" class="btn btn-floating btn-primary float-right btn-sm mt-1" data-toggle="tooltip" data-placement="left" data-trigger="hover" data-original-title="Add Coupon">
                                        ...
                                        <div class="row clearfix">
                                            <div class="col-lg-6 col-md-12 pd-0">
                                                <div class="form-group">
                                                    {!! Form::text('coupon_code', '', ['class' => 'form-control', 'id' => 'coupon_code', 'autocomplete' => 'off', 'placeholder' =>__('language.coupon_code'), ]) !!}
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-12">
                                                <div class="row">
                                                    <div class="col-lg-6 col-md-12">
                                                        <div class="form-group">
                                                            <button type="submit" class="btn btn-primary" name="Search" data-toggle="tooltip" data-placement="bottom" data-trigger="hover" data-original-title="{{ __('language.filter_coupon') }}">
                                                                <i class="fa fa-search"></i> &nbsp; {{ __('language.filter_coupon') }}
                                                            </button>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6 col-md-12">
                                    ...
                                    <div class="example">
                                        <div class="data-table-container">
                                            <div class="table-responsive">
                                                <table class="table table-bordered table-hover table-striped dataTable w-full" data-url="{{ route('adminPanel.coupon.getCoupons') }}" data-change-status-url="{{ route('adminPanel.coupon.changeStatus') }}" data-destroy-url="{{ route('adminPanel.coupon.destroy') }}">
...
<script src="{{ asset('admin-assets/js/coupon/view.js') }}"></script>
@endpush
