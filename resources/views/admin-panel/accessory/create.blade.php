...
@section('page-title', 'Add Accessory | Admin Panel')
@push('styles')
                        ...
                        <div class="col-lg-12">
                            <div class="">
                                ...
                                <div class="example-wrap">
                                    ...
                                    <div class="example">
                                        {!! Form::open(['class' => 'add-accessory-form', 'method' => 'post', 'url' => route('adminPanel.accessory.store'), 'files' => true ]) !!}
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group required">
                                                            ...
                                                            {!! Form::text('accessory_name', '', ['class' => 'form-control', 'id' => 'accessory_name', 'autocomplete' => 'off', 'placeholder' =>__('language.accessory_name'), required =>"required", 'maxlength' => '100', 'data-url' => route('adminPanel.accessory.checkAccessoryName')]) !!}
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group required">
                                                            <label class="form-control-label" for="colorpicker1">@lang('language.accessory_price')</label>
                                                            {!! Form::number('accessory_price', '', ['min' => 0, 'step' => 'any' ,'class' => 'form-control', 'id' => 'accessory_price', 'maxlength' => '6', 'autocomplete' => 'off', 'placeholder' =>__('language.accessory_price'), required =>"required"]) !!}
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-12 mt-20">
                                                    <div class="form-group mb-0">
                                                        <button type="submit" class="btn btn-primary btn-submit" data-toggle="tooltip" data-placement="top" data-trigger="hover" data-original-title="{{ __('language.create_accessory') }}">
                                                            <i class="fa fa-save"></i> &nbsp; {{ __('language.create_accessory') }}
                                                        </button>
                                                    </div>
                                                </div>
